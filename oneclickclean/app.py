...
try:
    from oneclickclean.cleaning import drop_id_columns, remove_duplicates, handle_missing, remove_outliers, fix_categorical
    from oneclickclean.visualization.boxplots import draw_boxplots
    from oneclickclean.script_generator import generate_cleaning_script
    from oneclickclean.visualization.dashboard import render_visualization
except ModuleNotFoundError:
    # Allows running from inside the oneclickclean folder (e.g. streamlit run app.py).
    from cleaning import drop_id_columns, remove_duplicates, handle_missing, remove_outliers, fix_categorical
    from visualization.boxplots import draw_boxplots
    from script_generator import generate_cleaning_script
    from visualization.dashboard import render_visualization
